...
submodule(tensor_map_m) tensor_map_s
  use julienne_m, only : call_julienne_assert_, operator(.equalsExpected.), separated_values
...
contains
  ...
  module procedure default_real_equals
    ...
    call_julienne_assert(allocated(lhs%layer_    ) .and. allocated(rhs%layer_    ))
    call_julienne_assert(allocated(lhs%intercept_) .and. allocated(rhs%intercept_))
    call_julienne_assert(allocated(lhs%slope_    ) .and. allocated(rhs%slope_    ))
  ...
  module procedure default_real_to_json
    ...
    call_julienne_assert(allocated(self%layer_))
    call_julienne_assert(allocated(self%intercept_) .and. allocated(self%slope_))
