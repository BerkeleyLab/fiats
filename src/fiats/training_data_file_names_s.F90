...
submodule(training_data_file_names_m) training_data_file_names_s
  use assert_m
  use julienne_m, only : operator(.csv.)
  implicit none

  character(len=*), parameter :: training_data_file_names_key = "training data file names"
...
contains
  ...
  module procedure from_json
    integer l
    logical training_data_file_names_key_found

    training_data_file_names_key_found = .false.
    ...
    call_assert(training_data_file_names_key_found)
  end procedure

  module procedure from_components
    training_data_file_names%path_ = path
    training_data_file_names%inputs_prefix_ = inputs_prefix
    training_data_file_names%outputs_prefix_ = outputs_prefix
    training_data_file_names%infixes_ = infixes
  end procedure
...
end submodule training_data_file_names_s
