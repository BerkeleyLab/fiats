...
module training_data_file_names_m
  use julienne_string_m, only : string_t
  implicit none

  private
  public :: training_data_file_names_t

  type training_data_file_names_t
    private
  ...
  interface training_data_file_names_t
    ...
    pure module function from_components(path, inputs_prefix, outputs_prefix, infixes) result(training_data_file_names)
      implicit none
  ...
  interface
    ...
    elemental module function equals(lhs, rhs) result(lhs_eq_rhs)
      implicit none
      class(training_data_file_names_t), intent(in) :: lhs, rhs
      logical lhs_eq_rhs
    end function
