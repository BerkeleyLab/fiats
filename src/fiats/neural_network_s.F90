...
contains
  ...
  module procedure default_real_consistency
    ...
    call_assert(all([allocated(self%weights_), allocated(self%biases_), allocated(self%nodes_)]))
  ...
  module procedure default_real_assert_conformable_with
    ...
    call_assert(.all. (shape(self%weights_) .equalsExpected. shape(neural_network%weights_)))
    call_assert(.all. (shape(self%biases_) .equalsExpected. shape(neural_network%biases_)))
    call_assert(.all. (shape(self%nodes_) .equalsExpected. shape(neural_network%nodes_)))
