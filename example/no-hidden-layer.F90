...
program learn_component_addition
  !! This trains a neural network to learn the following six polynomial functions of its eight inputs.
  use julienne_m, only : call_julienne_assert_, operator(.equalsExpected.), operator(.all.), operator(.also.)
  use fiats_m, only : &
