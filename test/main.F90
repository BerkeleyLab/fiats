...
program main
  ...
  use training_data_file_names_test_m, only : training_data_file_names_test_t
  ...
  type(training_data_file_names_test_t) training_data_file_names_test
  ...
  call training_data_file_names_test%report(passes, tests)
