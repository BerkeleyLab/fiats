...
![Neural network class diagram\label{fig:neural_network_t}](neural_network_t){ width=100% }
...
![String class diagram\label{fig:string_t}](string_t){ width=100% }
![Tensor class diagram\label{fig:tensor_t}](tensor_t){ width=100% }
![File class diagram\label{fig:file_t}](file_t){ width=100% }
